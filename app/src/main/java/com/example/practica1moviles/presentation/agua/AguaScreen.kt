package com.example.pc_practica.presentation.agua
...
fun AguaScreen(navController: NavController) {
    ...
    val scope = rememberCoroutineScope() // ✅ reemplaza LaunchedEffect
            ...
            Button(
                onClick = {
                    ...
                    if (nombre.isBlank() || pesoNum == null || pesoNum !in 5.0..200.0) {
                        resultado = ""
                        scope.launch {
                            snackbarHostState.showSnackbar("⚠️ Verifica los campos ingresados")
                        }
                    } else {
